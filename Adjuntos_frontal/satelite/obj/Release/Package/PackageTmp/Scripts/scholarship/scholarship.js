...
function GetRowsRequest(dataRequest) {
    ...
    allowCode = dataRequest.ALLOW_CODE;
    ...
    for (var i = 0; i < requirements.length; i++) {
        ...
        linkUpload = ( (allowCode != requirements[i].KVRAREQ_TRST_CODE) && (statusLock != "Y") ) ? '<a class="link-modal" title = "Cargar adjunto" href = "javascript:void(0)" onclick = "OpenModalUploadFile(\'' + requirements[i].KVRAREQ_TREQ_CODE + '\')" > ' +
